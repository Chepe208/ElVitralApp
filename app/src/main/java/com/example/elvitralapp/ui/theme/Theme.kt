package com.example.elvitralapp.ui.theme
...
enum class ThemeMode { DARK, LIGHT, DARK_MEDIUM, LIGHT_MEDIUM, DARK_HIGH, LIGHT_HIGH }

val LocalThemeMode    = compositionLocalOf { ThemeMode.DARK }
val LocalOnCycleTheme = compositionLocalOf<() -> Unit> { {} }
...
fun ElVitralAppTheme(
    ...
    CompositionLocalProvider(
        ...
        LocalOnCycleTheme provides onCycleTheme
    ) {
        MaterialTheme(
